...
namespace EczacibasiHW1.Models.Repository
{
    public class BookRepository : IBookRepository
    {
        ...
        public BookRepository(CommerceContext context, IMapper mapper, ICategoryRepository categoryRepository)
        {
            _context = context;
            _mapper = mapper;
        ...
        public List<Book> GetByTitle(string title, bool withCategory = false)
        {
            var query = _context.Books.AsQueryable();
        ...
        public List<Book> GetByISBN(string ISBN, bool withCategory = false)
        {
            var query = _context.Books.AsQueryable();
        ...
        public List<Book> GetAll(int page, int pageSize, string v)
        {
